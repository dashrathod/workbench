$(document).ready(function () {
     ...
     function formatSiteInfo(d) {
          ...
          <div class="alert alert-info">
               <table class="table" id="siteInfoExp" width="100%">
                    <thead>
                         <tr>
                              <th><input type="checkbox" onclick="javascript:void(0)"></th>
                              <th>Contact Name</th>
                              <th>Contact Email</th>
                    ...
                    <tbody>
                         <tr>
                              <td><input type="checkbox" onclick="javascript:void(0)"></td>
                              <td>Rakesh Kumar</td>
               ...
               <div class="pagination">
                    <div class="col-md-6 text-left">
                         show <input type="text" class="pgnIpt" value="01" /> of 10
                    </div>
     ...
     $('#siteInfo tbody td:not(:first-child)').click(function () {
          ...
          if (row.child.isShown()) {
               ...
               // Open this row
               row.child(formatSiteInfo(row.data())).show();
               tr.addClass('shown');
          }
     });
});